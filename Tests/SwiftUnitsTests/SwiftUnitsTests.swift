...
extension SwiftUnitsTests {
    ...
    func test_conversion_density() {
        ...
        XCTAssert(result == expected_result, "test_conversion_density;result=\(result);expected_result=\(expected_result)")
    ...
    func test_conversion_frequency() {
        ...
        XCTAssert(result == expected_result, "test_conversion_frequency;result=\(result);expected_result=\(expected_result)")
    ...
    func test_conversion_mass() {
        ...
        XCTAssert(result == expected_result, "test_conversion_mass;result=\(result);expected_result=\(expected_result)")
    ...
    func test_conversion_temperature() {
        ...
        XCTAssert(result == expected_result, "test_conversion_temperature;result=\(result);expected_result=\(expected_result)")
